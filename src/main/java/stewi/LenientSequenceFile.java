 ...
 * pairs.
 *
 * <p><code>SequenceFile</code> provides {@link LenientSequenceFile.Writer},
 * {@link LenientSequenceFile.Reader} and {@link Sorter} classes for writing,
 ...
 *
 * <p>The {@link LenientSequenceFile.Reader} acts as the bridge and can read any of the
...
public class LenientSequenceFile {
  private static final Log LOG = LogFactory.getLog(LenientSequenceFile.class);

  private LenientSequenceFile() {}                         // no public ctor
   ...
   * {@link LenientSequenceFile}.
   *
   * @see LenientSequenceFile.Writer
   */
  ...
  public static class Writer implements java.io.Closeable, Syncable {
    ...
    private static Option filesystem(FileSystem fs) {
      return new LenientSequenceFile.Writer.FileSystemOption(fs);
    }
     ...
     * @deprecated Use
     *   {@link LenientSequenceFile#createWriter(Configuration, Writer.Option...)}
     *   instead.
     */
    @Deprecated
     ...
     * immediately after calling {@link LenientSequenceFile.Reader#seek(long)} with a position
     * returned by this method, {@link LenientSequenceFile.Reader#next(Writable)} may be called.  However
  ...
  public static class Reader implements java.io.Closeable {
     ...
     *                  reader {@link LenientSequenceFile.Sorter.cloneFileAttributes},
    ...
    public synchronized boolean next(Writable key, Writable val)
      ...
      try {
        ...
        LOG.trace("truncated record in file: "+filename);
        more = false;
      }
     ...
     * LenientSequenceFile.Writer#getLength()} when writing this file.  To seek to an arbitrary
     * position, use {@link LenientSequenceFile.Reader#sync(long)}.
     */
